...
// PR-7: styles.css is split by section into styles/sections/*.css
// (manifest: styles/sections/manifest.json). Import order preserves
// the original cascade order exactly — CSS is order-sensitive.
import "./styles/sections/preamble.css";
import "./styles/sections/trainer-design-tokens-base-styles.css";
import "./styles/sections/reset-base.css";
...
import "./styles/sections/menu-lists.css";
import "./styles/sections/composer.css";
import "./styles/sections/message-bubbles.css";
import "./styles/sections/message-markdown.css";
import "./styles/sections/code-block-with-copy-button.css";
import "./styles/sections/message-rich-content.css";
import "./styles/sections/message-support-lines.css";
import "./styles/sections/message-table.css";
import "./styles/sections/mermaid-block.css";
import "./styles/sections/artifact-card.css";
import "./styles/sections/collapsible-block.css";
import "./styles/sections/coach-conversation-view.css";
import "./styles/sections/coach-empty-state.css";
import "./styles/sections/coach-plan-view.css";
import "./styles/sections/coach-settings-view.css";
import "./styles/sections/settings-sheet.css";
import "./styles/sections/settings-section.css";
import "./styles/sections/settings-grid-field.css";
import "./styles/sections/settings-actions.css";
import "./styles/sections/command-deck.css";
import "./styles/sections/suggested-actions.css";
import "./styles/sections/research-cards.css";
import "./styles/sections/coach-deep-analysis.css";
import "./styles/sections/composer-enhancements.css";
import "./styles/sections/message-bubble-v2.css";
import "./styles/sections/trainer-agent-loop-activity-strip.css";
import "./styles/sections/composer-image-attachments.css";
import "./styles/sections/narrow-sidebar-recovery.css";
import "./styles/sections/surface-materials-document-column-hairline-chrome-crafted-disclosure.css";
import "./styles/sections/plan-stage-learning-materials-f1-training-card-mismatch-recovery-f2.css";
import "./styles/sections/plan-progress-dashboard-plan-view-inner-progress-tab.css";
import "./styles/sections/collapsesection-the-unified-multi-level-folding-primitive.css";
import "./styles/sections/shared-design-system-primitives-empty-state-skeleton-shimmer.css";
import "./styles/sections/resources-workbench-w1-collapsesection-collections-row.css";
import "./styles/sections/coach-conversation-polish-w2-additive-coach-classes.css";
import "./styles/sections/plan-view-staging-w3-w1-stage-collapsesections-with-the.css";
import "./styles/sections/w4-w1-training-unified-card-texture-motion.css";
import "./styles/sections/settings-additive-layer-for-the-collapsesection-container-swap.css";
import "./styles/sections/settings-ia-rebuild-status-summary-bar-section-anchors.css";
import "./styles/sections/message-bubble-refinement-pass-premium-surfaces-calmer-hierarchy.css";
