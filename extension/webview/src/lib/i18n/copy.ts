...
export type CopyKey =
  ...
  | "onboardingTitle"
  | "onboardingStepWorkspaceRoot"
  | "onboardingStepTrust"
  | "onboardingStepConnectModel"
  | "onboardingRootDetail"
  ...
  | "onboardingModelPastePlaceholder"
  | "onboardingModelParsed"
  | "onboardingModelKeyLabel"
  | "onboardingModelKeyPlaceholder"
  | "onboardingModelKeyStored"
  | "onboardingModelSave"
  ...
  | "settingsMemoryPersonalTrustDisable"
  | "archivePrivacyNote"
...
export const copyTable = {
  ...
  "zh-CN": {
    ...
    settingsMemorySharingDetail: "默认全局记忆：所有 Trainer 项目共享你的偏好与掌握信号；切回“当前项目”即恢复隔离。",
    ...
    onboardingModelKeyLabel: "API 密钥",
    onboardingModelKeyPlaceholder: "粘贴密钥(sk-…)",
    onboardingModelKeyStored: "密钥已保存",
    onboardingModelParsed: "已识别：地址与密钥已自动填入。",
    onboardingModelPasteLabel: "服务地址或连接信息",
    ...
    settingsMemoryPersonalTrustDetail: "全局（默认）会跨 Trainer 项目共享偏好与掌握度；当前项目会恢复强隔离。计划、对话与资料始终隔离。",
    settingsMemoryPersonalTrustDisable: "切换到当前项目",
    settingsMemoryPersonalTrustEnable: "使用全局（默认）",
    settingsMemoryPersonalTrustTitle: "记忆范围",
    ...
    onboardingStepConnectModel: "连接模型",
    onboardingStepTrust: "信任此窗口",
    onboardingStepWorkspaceRoot: "选择学习文件夹",
    onboardingTitle: "三步开始训练",
  ...
  "en-US": {
    ...
    settingsMemorySharingDetail: "Global memory by default: all Trainer projects share your preferences and mastery signals; switch to Current project to isolate.",
    ...
    onboardingModelKeyLabel: "API key",
    onboardingModelKeyPlaceholder: "Paste your key (sk-…)",
    onboardingModelKeyStored: "Key saved",
    onboardingModelParsed: "Recognized: address and key were filled in.",
    onboardingModelPasteLabel: "Service address or connection info",
    ...
    settingsMemoryPersonalTrustDetail: "Global (default) shares preferences and mastery across Trainer projects; Current project restores strict isolation. Plans, conversations, and resources always stay isolated.",
    settingsMemoryPersonalTrustDisable: "Use current project",
    settingsMemoryPersonalTrustEnable: "Use global (default)",
    settingsMemoryPersonalTrustTitle: "Memory scope",
    ...
    onboardingStepConnectModel: "Connect a model",
    onboardingStepTrust: "Trust this window",
    onboardingStepWorkspaceRoot: "Choose your learning folder",
  ...
  "es-ES": {
    ...
    onboardingModelKeyLabel: "Clave API",
    onboardingModelKeyPlaceholder: "Pega tu clave (sk-…)",
    onboardingModelKeyStored: "Clave guardada",
    onboardingModelParsed: "Reconocido: la dirección y la clave se rellenaron automáticamente.",
    onboardingModelPasteLabel: "Dirección del servicio o información de conexión",
    ...
    settingsMemoryPersonalTrustDetail: "Global (predeterminado) comparte preferencias y dominio entre proyectos Trainer; Proyecto actual restaura el aislamiento estricto. Planes, conversaciones y recursos siempre quedan aislados.",
    settingsMemoryPersonalTrustDisable: "Usar proyecto actual",
    settingsMemoryPersonalTrustEnable: "Usar global (predeterminado)",
    settingsMemoryPersonalTrustTitle: "Ámbito de memoria",
    ...
    onboardingStepConnectModel: "Conecta un modelo",
    onboardingStepTrust: "Confía en esta ventana",
    onboardingStepWorkspaceRoot: "Elige tu carpeta de aprendizaje",
  ...
  "fr-FR": {
    ...
    onboardingModelKeyLabel: "Clé API",
    onboardingModelKeyPlaceholder: "Collez votre clé (sk-…)",
    onboardingModelKeyStored: "Clé enregistrée",
    onboardingModelParsed: "Reconnu : l’adresse et la clé ont été remplies automatiquement.",
    onboardingModelPasteLabel: "Adresse du service ou infos de connexion",
    ...
    settingsMemoryPersonalTrustDetail: "Global (par défaut) partage préférences et maîtrise entre les projets Trainer ; Projet actuel rétablit l’isolation stricte. Plans, conversations et ressources restent toujours isolés.",
    settingsMemoryPersonalTrustDisable: "Utiliser le projet actuel",
    settingsMemoryPersonalTrustEnable: "Utiliser global (par défaut)",
    settingsMemoryPersonalTrustTitle: "Portée de la mémoire",
    ...
    onboardingStepConnectModel: "Connectez un modèle",
    onboardingStepTrust: "Faites confiance à cette fenêtre",
    onboardingStepWorkspaceRoot: "Choisissez votre dossier d’apprentissage",
    onboardingTitle: "Trois étapes pour démarrer",
  ...
  "de-DE": {
    ...
    onboardingModelKeyLabel: "API-Schlüssel",
    onboardingModelKeyPlaceholder: "Schlüssel einfügen (sk-…)",
    onboardingModelKeyStored: "Schlüssel gespeichert",
    onboardingModelParsed: "Erkannt: Adresse und Schlüssel wurden automatisch eingetragen.",
    onboardingModelPasteLabel: "Dienstadresse oder Verbindungsinfos",
    ...
    settingsMemoryPersonalTrustDetail: "Global (Standard) teilt Präferenzen und Kompetenz zwischen Trainer-Projekten; Aktuelles Projekt stellt strikte Isolation wieder her. Pläne, Gespräche und Materialien bleiben immer isoliert.",
    settingsMemoryPersonalTrustDisable: "Aktuelles Projekt verwenden",
    settingsMemoryPersonalTrustEnable: "Global verwenden (Standard)",
    settingsMemoryPersonalTrustTitle: "Speicherbereich",
    ...
    onboardingStepConnectModel: "Modell verbinden",
    onboardingStepTrust: "Diesem Fenster vertrauen",
    onboardingStepWorkspaceRoot: "Lernordner wählen",
    onboardingTitle: "Drei Schritte zum Start",
  ...
  "ja-JP": {
    ...
    onboardingModelKeyLabel: "API キー",
    onboardingModelKeyPlaceholder: "キーを貼り付け (sk-…)",
    onboardingModelKeyStored: "キーは保存済み",
    onboardingModelParsed: "認識しました：アドレスとキーを自動入力しました。",
    onboardingModelPasteLabel: "サービスアドレスまたは接続情報",
    ...
    settingsMemoryPersonalTrustDetail: "グローバル（既定）は Trainer プロジェクト間で設定と習熟度を共有し、現在のプロジェクトは厳密な分離に戻します。プラン・会話・資料は常に分離されます。",
    settingsMemoryPersonalTrustDisable: "現在のプロジェクトを使用",
    settingsMemoryPersonalTrustEnable: "グローバルを使用（既定）",
    settingsMemoryPersonalTrustTitle: "記憶の範囲",
    ...
    onboardingStepConnectModel: "モデルに接続",
    onboardingStepTrust: "このウィンドウを信頼",
    onboardingStepWorkspaceRoot: "学習フォルダーを選ぶ",
  ...
  "ko-KR": {
    ...
    onboardingModelKeyLabel: "API 키",
    onboardingModelKeyPlaceholder: "키 붙여넣기 (sk-…)",
    onboardingModelKeyStored: "키 저장됨",
    onboardingModelParsed: "인식됨: 주소와 키가 자동으로 채워졌습니다.",
    onboardingModelPasteLabel: "서비스 주소 또는 연결 정보",
    ...
    settingsMemoryPersonalTrustDetail: "전역(기본)은 Trainer 프로젝트 간에 환경설정과 숙련도를 공유하고, 현재 프로젝트는 강한 격리로 되돌립니다. 계획, 대화, 자료는 항상 격리됩니다.",
    settingsMemoryPersonalTrustDisable: "현재 프로젝트 사용",
    settingsMemoryPersonalTrustEnable: "전역 사용(기본)",
    settingsMemoryPersonalTrustTitle: "메모리 범위",
    ...
    onboardingStepConnectModel: "모델 연결",
    onboardingStepTrust: "이 창 신뢰",
    onboardingStepWorkspaceRoot: "학습 폴더 선택",
    onboardingTitle: "세 단계로 시작",
  ...
  "pt-BR": {
    ...
    onboardingModelKeyLabel: "Chave da API",
    onboardingModelKeyPlaceholder: "Cole sua chave (sk-…)",
    onboardingModelKeyStored: "Chave salva",
    onboardingModelParsed: "Reconhecido: endereço e chave preenchidos automaticamente.",
    onboardingModelPasteLabel: "Endereço do serviço ou informações de conexão",
    ...
    settingsMemoryPersonalTrustDetail: "Global (padrão) compartilha preferências e domínio entre projetos Trainer; Projeto atual restaura o isolamento estrito. Planos, conversas e recursos permanecem sempre isolados.",
    settingsMemoryPersonalTrustDisable: "Usar projeto atual",
    settingsMemoryPersonalTrustEnable: "Usar global (padrão)",
    settingsMemoryPersonalTrustTitle: "Escopo da memória",
    ...
    onboardingStepConnectModel: "Conecte um modelo",
    onboardingStepTrust: "Confie nesta janela",
    onboardingStepWorkspaceRoot: "Escolha sua pasta de aprendizado",
    onboardingTitle: "Três passos para começar",
...
const resourceViewLocaleOverrides: Partial<Record<ComposerLanguage, Partial<Copy>>> = {
  "es-ES": {
    ...
    settingsMemorySharingDetail: "Memoria global por defecto: todos los proyectos de Trainer comparten preferencias y señales de dominio; cambia a Proyecto actual para aislar.",
  ...
  "fr-FR": {
    ...
    settingsMemorySharingDetail: "Mémoire globale par défaut : tous les projets Trainer partagent préférences et signaux de maîtrise ; passez au Projet actuel pour isoler.",
  ...
  "de-DE": {
    ...
    settingsMemorySharingDetail: "Standardmäßig globaler Speicher: Alle Trainer-Projekte teilen Präferenzen und Kompetenzsignale; mit Aktuelles Projekt isolieren.",
  ...
  "ja-JP": {
    ...
    settingsMemorySharingDetail: "既定でグローバル記憶：すべての Trainer プロジェクトが設定と習熟シグナルを共有します。現在のプロジェクトに切り替えると分離されます。",
  ...
  "ko-KR": {
    ...
    settingsMemorySharingDetail: "기본 전역 기억: 모든 Trainer 프로젝트가 환경설정과 숙련 신호를 공유합니다. 현재 프로젝트로 전환하면 격리됩니다.",
  ...
  "pt-BR": {
    ...
    settingsMemorySharingDetail: "Memória global por padrão: todos os projetos do Trainer compartilham preferências e sinais de domínio; mude para Projeto atual para isolar.",
