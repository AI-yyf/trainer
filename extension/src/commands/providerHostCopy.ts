...
export type ProviderHostCopyKey =
  ...
  | 'speedTestInvalidUrl'
  | 'speedTestTimedOut'
  | 'speedTestConnectFailed'
  | 'speedTestRequestFailed'
  | 'speedTestAdoptFastest'
  | 'modelAutoSelectedSuffix'
  | 'switchVerifying'
  | 'switchAlreadyActive'
...
const providerHostCopyTable: Record<ComposerLanguage, ProviderHostCopyTable> = {
  'zh-CN': {
    ...
    speedTestLabel: '端点测速',
    speedTestDetail: '对服务地址做一次轻量测速(不消耗模型额度),点结果行可直接采用该地址。',
    speedTestNoUrls: '请先填写服务地址,或添加要测速的端点。',
    speedTestUntrusted: '当前工作区未被信任,Trainer 无法发起端点测速。',
    speedTestInvalidUrl: 'URL 无效。',
    speedTestTimedOut: '请求超时。',
    speedTestConnectFailed: '连接失败。',
    speedTestRequestFailed: '请求失败。',
    speedTestAdoptFastest: '采用最快端点',
  ...
  'en-US': {
    ...
    speedTestLabel: 'Endpoint speed test',
    speedTestDetail: 'Lightweight latency test for service addresses (no model quota used). Click a result row to adopt that address.',
    speedTestNoUrls: 'Add the service address or an endpoint to test first.',
    speedTestUntrusted: 'The current workspace is not trusted, so Trainer cannot run the speed test.',
    speedTestInvalidUrl: 'Invalid URL.',
    speedTestTimedOut: 'Request timed out.',
    speedTestConnectFailed: 'Could not connect.',
    speedTestRequestFailed: 'Request failed.',
    speedTestAdoptFastest: 'Use fastest',
  ...
  'es-ES': {
    ...
    speedTestLabel: 'Prueba de velocidad del endpoint',
    speedTestDetail: 'Prueba ligera de latencia para direcciones de servicio (no consume cuota del modelo). Haz clic en una fila para adoptar esa dirección.',
    speedTestNoUrls: 'Añade primero la dirección de servicio o un endpoint para probar.',
    speedTestUntrusted: 'El espacio de trabajo actual no es de confianza; Trainer no puede ejecutar la prueba.',
    speedTestInvalidUrl: 'URL no válida.',
    speedTestTimedOut: 'Tiempo de espera agotado.',
    speedTestConnectFailed: 'No se pudo conectar.',
    speedTestRequestFailed: 'Solicitud fallida.',
    speedTestAdoptFastest: 'Usar el más rápido',
  ...
  'fr-FR': {
    ...
    speedTestLabel: 'Test de vitesse du endpoint',
    speedTestDetail: 'Test de latence léger des adresses de service (n\'utilise pas de quota de modèle). Cliquez sur une ligne pour adopter cette adresse.',
    speedTestNoUrls: 'Ajoutez d\'abord l\'adresse de service ou un endpoint à tester.',
    speedTestUntrusted: 'L\'espace de travail actuel n\'est pas approuvé ; Trainer ne peut pas lancer le test.',
    speedTestInvalidUrl: 'URL invalide.',
    speedTestTimedOut: 'Délai dépassé.',
    speedTestConnectFailed: 'Connexion impossible.',
    speedTestRequestFailed: 'Échec de la requête.',
    speedTestAdoptFastest: 'Utiliser le plus rapide',
  ...
  'de-DE': {
    ...
    speedTestLabel: 'Endpoint-Geschwindigkeitstest',
    speedTestDetail: 'Leichter Latenztest für Dienstadressen (verbraucht kein Modellkontingent). Klicke auf eine Zeile, um die Adresse zu übernehmen.',
    speedTestNoUrls: 'Füge zuerst die Dienstadresse oder einen Endpoint hinzu.',
    speedTestUntrusted: 'Der aktuelle Workspace ist nicht vertrauenswürdig; Trainer kann den Test nicht starten.',
    speedTestInvalidUrl: 'Ungültige URL.',
    speedTestTimedOut: 'Zeitüberschreitung.',
    speedTestConnectFailed: 'Verbindung fehlgeschlagen.',
    speedTestRequestFailed: 'Anfrage fehlgeschlagen.',
    speedTestAdoptFastest: 'Schnellsten übernehmen',
  ...
  'ja-JP': {
    ...
    speedTestLabel: 'エンドポイント速度テスト',
    speedTestDetail: 'サービスアドレスの軽量レイテンシ測定(モデルのquotaは消費しません)。結果行をクリックするとそのアドレスを採用します。',
    speedTestNoUrls: 'まずサービスアドレスまたはテストするエンドポイントを追加してください。',
    speedTestUntrusted: '現在のワークスペースが信頼されていないため、速度テストを実行できません。',
    speedTestInvalidUrl: 'URLが無効です。',
    speedTestTimedOut: 'リクエストがタイムアウトしました。',
    speedTestConnectFailed: '接続できませんでした。',
    speedTestRequestFailed: 'リクエストに失敗しました。',
    speedTestAdoptFastest: '最速を採用',
  ...
  'ko-KR': {
    ...
    speedTestLabel: '엔드포인트 속도 테스트',
    speedTestDetail: '서비스 주소의 가벼운 지연 시간 테스트(모델 할당량 소모 없음). 결과 행을 클릭하면 해당 주소를 적용합니다.',
    speedTestNoUrls: '먼저 서비스 주소 또는 테스트할 엔드포인트를 추가하세요.',
    speedTestUntrusted: '현재 워크스페이스가 신뢰되지 않아 속도 테스트를 실행할 수 없습니다.',
    speedTestInvalidUrl: '잘못된 URL입니다.',
    speedTestTimedOut: '요청 시간이 초과되었습니다.',
    speedTestConnectFailed: '연결 실패.',
    speedTestRequestFailed: '요청 실패.',
    speedTestAdoptFastest: '가장 빠른 것 사용',
  ...
  'pt-BR': {
    ...
    speedTestLabel: 'Teste de velocidade do endpoint',
    speedTestDetail: 'Teste leve de latência para endereços de serviço (não consome cota do modelo). Clique em uma linha para adotar aquele endereço.',
    speedTestNoUrls: 'Adicione primeiro o endereço de serviço ou um endpoint para testar.',
    speedTestUntrusted: 'O workspace atual não é confiável; o Trainer não pode executar o teste.',
    speedTestInvalidUrl: 'URL inválida.',
    speedTestTimedOut: 'Tempo limite esgotado.',
    speedTestConnectFailed: 'Falha na conexão.',
    speedTestRequestFailed: 'Falha na solicitação.',
    speedTestAdoptFastest: 'Usar o mais rápido',
