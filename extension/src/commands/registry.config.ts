...
export function buildCommandRegistrations(context: CommandContext): CommandRegistration[] {
  ...
  return [
    ...
    { commandId: COMMAND_IDS.trainingAttemptStart, register: (ctx, payload) => trainingAttemptStartCommand(ctx, payload) },
    { commandId: COMMAND_IDS.trainingAttemptUpdate, register: (ctx, payload) => trainingAttemptUpdateCommand(ctx, payload) },
